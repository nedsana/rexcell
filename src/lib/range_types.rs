...
impl<'a> IRange for RangeMultiline<'a> {
    ...
    fn compare_range(&self, other: &dyn IRange, strict: bool, o_use_rows: Option<vec::Vec<u32>>, o_use_cols: Option<vec::Vec<u32>>) -> bool 
    {
        ...
        if strict && (rows_a != rows_b || cols_a != cols_b) 
        {
            println!("[RangeMultiline::compare_range] Size missmatch! Range A:[{}, len:{}] != Range B:[{}, len:{}]", 
                    range_ops::range_to_string(range_a), rows_a, range_ops::range_to_string(range_b), rows_b);
            return false;
        }
    ...
    fn compare_cell(&self, other: &dyn IRange, col_a: u32, row_a: u32, col_b: u32, row_b: u32, strict: bool) -> bool 
    {
        ...
        if rich_a != rich_b && strict
        {
            println!("[RangeMultiline::compare_cell] Rich text mismatch: {}:{} and {}:{}", range_ops::coords_to_str(col_a, row_a), val_a, range_ops::coords_to_str(col_b, row_b), val_b);
            return r;
        }
        ...
        if range_ops::cmp_strs(&val_a, &val_b) 
        {
            println!("[RangeMultiline::compare_cell] {}:{} equals {}:{}", range_ops::coords_to_str(col_a, row_a), val_a, range_ops::coords_to_str(col_b, row_b), val_b);
            r = true;
        }
        else 
        {
            println!("[RangeMultiline::compare_cell] {}:{} differs {}:{}", range_ops::coords_to_str(col_a, row_a), val_a, range_ops::coords_to_str(col_b, row_b), val_b); 
            r = false;
        }
        r
    }
...
impl<'a> IRange for RangeMultilineMut<'a> {
    ...
    fn compare_range(&self, other: &dyn IRange, strict: bool, o_use_rows: Option<vec::Vec<u32>>, o_use_cols: Option<vec::Vec<u32>>) -> bool 
    {
        ...
        if strict && (rows_a != rows_b || cols_a != cols_b) 
        {
            println!("[RangeMultilineMut::compare_range] Size missmatch! Range A:[{}, len:{}] != Range B:[{}, len:{}]", 
                    range_ops::range_to_string(range_a), rows_a, range_ops::range_to_string(range_b), rows_b);
            return false;
        }
    ...
    fn compare_cell(&self, other: &dyn IRange, col_a: u32, row_a: u32, col_b: u32, row_b: u32, strict: bool) -> bool 
    {
        ...
        if rich_a != rich_b && strict
        {
            println!("[RangeMultilineMut::compare_cell] Rich text mismatch: {}:{} and {}:{}", range_ops::coords_to_str(col_a, row_a), val_a, range_ops::coords_to_str(col_b, row_b), val_b);
            return r;
        }
        ...
        if range_ops::cmp_strs(&val_a, &val_b) 
        {
            println!("[RangeMultilineMut::compare_cell] {}:{} equals {}:{}", range_ops::coords_to_str(col_a, row_a), val_a, range_ops::coords_to_str(col_b, row_b), val_b);
            r = true;
        }
        else 
        {
            println!("[RangeMultilineMut::compare_cell] {}:{} differs {}:{}", range_ops::coords_to_str(col_a, row_a), val_a, range_ops::coords_to_str(col_b, row_b), val_b); 
            r = false;
        }
        r
    }
